...
public class AmuseNewsFragment extends Fragment {
    private ListView listView;
    String TAG = "abace";
    private String URLs ="http://api.dagoogle.cn/news/get-news?tableNum=2&pagesize=10";
    ...
    class NewsAsyncTask extends AsyncTask<String,Void,List<NewsBean>>{
        ...
        protected void onPostExecute(List<NewsBean>nesBeanList) {
            ...
            NewsAdapter newsAdapter = new NewsAdapter(AmuseNewsFragment.this.getActivity(),nesBeanList);
            listView.setAdapter(newsAdapter);
        }
    }
}
