...
public class FinanceNewsFragment extends Fragment {
    ...
    String TAG = "abace";
    private String URLs ="http://api.dagoogle.cn/news/get-news?tableNum=5&pagesize=10";
    ...
    class NewsAsyncTask extends AsyncTask<String,Void,List<NewsBean>>{
        ...
        protected void onPostExecute(List<NewsBean>nesBeanList) {
            ...
            NewsAdapter newsAdapter = new NewsAdapter(FinanceNewsFragment.this.getActivity(),nesBeanList);
            listView.setAdapter(newsAdapter);
        }
    }
}
