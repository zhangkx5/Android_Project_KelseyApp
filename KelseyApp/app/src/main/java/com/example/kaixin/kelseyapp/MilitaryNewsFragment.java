...
public class MilitaryNewsFragment extends Fragment {
    ...
    String TAG = "abace";
    private String URLs ="http://api.dagoogle.cn/news/get-news?tableNum=3&pagesize=10";
    ...
    class NewsAsyncTask extends AsyncTask<String,Void,List<NewsBean>>{
        ...
        protected void onPostExecute(List<NewsBean>nesBeanList) {
            ...
            NewsAdapter newsAdapter = new NewsAdapter(MilitaryNewsFragment.this.getActivity(),nesBeanList);
            listView.setAdapter(newsAdapter);
        }
    }
}
