...
public class STechNewsFragment extends Fragment {
    private ListView listView;
    String TAG = "abace";
    private String URLs ="http://api.dagoogle.cn/news/get-news?tableNum=8&pagesize=10";
    ...
    class NewsAsyncTask extends AsyncTask<String,Void,List<NewsBean>>{
        ...
        protected void onPostExecute(List<NewsBean>nesBeanList) {
            ...
            NewsAdapter newsAdapter = new NewsAdapter(STechNewsFragment.this.getActivity(),nesBeanList);
            listView.setAdapter(newsAdapter);
        }
    }
}
